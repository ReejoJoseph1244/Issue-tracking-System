...
<body>
<div class="sidebar" style="background-color: #77bc3f;">
    <nav class="sidebar-nav" style="background-color: #77bc3f;">

        <ul class="nav" style="background-color: #77bc3f;" >
            @can('dashboard_access')
                <li class="nav-item" style="background-color: #77bc3f;">
